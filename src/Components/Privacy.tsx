...
const PrivacyPolicy = () => {
    return (
        <Container>
            ...
            <TextWrapper>
                <Text>DMSport 개인정보처리방침<br /></Text>
                <Text>DMSport이(가) 취급하는 모든 개인정보는 개인정보보호법 등 관련 법령상의 개인정보보호 규정을 준수하여 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.<br /></Text>
                <Text>
                ...
                <Text>2 개인정보의 처리 및 보유 기간 작성<br /></Text>
                <Text>① DMSport은(는) 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보 보유·이용기간 또는 법령에 따른 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.<br /></Text>
                <Text>
                    ② 구체적인 개인정보 처리 및 보유 기간은 다음과 같습니다.<br />
                    고객 가입 및 관리 : 서비스 이용계약 또는 회원가입 해지시까지, 다만 채권·채무관계 잔존시에는 해당 채권·채무관계 정산시까지<br />
                </Text>
                <Text>전자상거래에서의 계약·청약철회, 대금결제, 재화 등 공급기록 : 5년<br /></Text>
                <Text>3 정보주체와 법정대리인의 권리·의무 및 그 행사방법<br /></Text>
                <Text>
                ...
                <Text>6 개인정보 자동 수집 장치의 설치·운영 및 그 거부에 관한 사항<br /></Text>
                <Text>① DMSport은 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용합니다.<br /></Text>
                <Text>
