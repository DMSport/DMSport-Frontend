    ...
    return (
        <>
            <Wrapper>
                ...
                <Paragraph>
                    제 1 조 (목적)<br />
                    이 약관은 DMSport(이하 "사이트"라 합니다)에서 제공하는 인터넷서비스(이하 "서비스"라 합니다)의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다.<br />
                </Paragraph>
                <Paragraph>
                ...
                <Paragraph>제 2 장 서비스 이용계약<br /></Paragraph>            <Paragraph>
                    제 4 조 (이용계약의 성립)<br />
                ...
                <Paragraph>제 3 장 계약 당사자의 의무<br /></Paragraph>
                <Paragraph>
                    제 8 조 (사이트의 의무)<br />
                ...
                <Paragraph>제 4 장 서비스 제공 및 이용<br /></Paragraph>
                <Paragraph>
                ...
                <Paragraph>제5장 계약사항의 변경, 해지<br /></Paragraph>
                <Paragraph>
                    제 12 조 (정보의 변경)<br />
                ...
                <Paragraph>제6장 손해배상<br /></Paragraph>
                <Paragraph>
                    제 14 조 (면책조항)
                ...
                <Paragraph>제 15 조 (관할법원)<br /></Paragraph>
                <Paragraph>서비스와 관련하여 사이트와 회원간에 분쟁이 발생할 경우 사이트의 본사 소재지를 관할하는 법원을 관할법원으로 합니다.<br /></Paragraph>
                <Paragraph>[부칙]<br /></Paragraph>
                <Paragraph>(시행일) 이 약관은 B.C 500만년 1월부터 시행합니다.<br /></Paragraph>
            </Wrapper>
        </>
    )
}
