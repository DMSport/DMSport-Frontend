import * as _ from "./Privacy.style"

const PrivacyPolicy = () => {
    return (
        <_.Container>
            <_.TitleText>개인정보처리방침</_.TitleText>
            <_.Text>DMSport 개인정보처리방침<br /></_.Text>
            <_.Text>DMSport이(가) 취급하는 모든 개인정보는 개인정보보호법 등 관련 법령상의 개인정보보호 규정을 준수하여 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.<br /></_.Text>
            <_.Text>
                ① DMSport은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.<br />
                고객 가입의사 확인, 고객에 대한 서비스 제공에 따른 본인 식별·인증, 회원자격 유지·관리, 물품 또는 서비스 공급에 따른 금액 결제, 물품 또는 서비스의 공급·배송, 마케팅 및 광고에의 활용<br />
            </_.Text>
            <_.Text>2 개인정보의 처리 및 보유 기간 작성<br /></_.Text>
            <_.Text>① DMSport은(는) 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보 보유·이용기간 또는 법령에 따른 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.<br /></_.Text>
            <_.Text>
                ② 구체적인 개인정보 처리 및 보유 기간은 다음과 같습니다.<br />
                고객 가입 및 관리 : 서비스 이용계약 또는 회원가입 해지시까지, 다만 채권·채무관계 잔존시에는 해당 채권·채무관계 정산시까지<br />
            </_.Text>
            <_.Text>전자상거래에서의 계약·청약철회, 대금결제, 재화 등 공급기록 : 5년<br /></_.Text>
            <_.Text>3 정보주체와 법정대리인의 권리·의무 및 그 행사방법<br /></_.Text>
            <_.Text>
                정보주체는 DMSport에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.<br />
                1. 개인정보 열람요구<br />
            ...
            <_.Text>6 개인정보 자동 수집 장치의 설치·운영 및 그 거부에 관한 사항<br /></_.Text>
            <_.Text>① DMSport은 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용합니다.<br /></_.Text>
            <_.Text>
